...
export default function ReviewSlider({ mob }) {
  ...
  return (
    <div style={{ 
      ...
      {/* Background Decor */}
      <div style={{ position: 'absolute', right: '-40px', top: '-40px', width: '150px', height: '150px', background: 'radial-gradient(circle, #FF9431 0%, transparent 70%)', opacity: 0.08, pointerEvents: 'none' }} />
            ...
            >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  ...
                  <button 
                    type="submit"
                    style={{ flex: 1, padding: '14px', borderRadius: '12px', background: 'linear-gradient(135deg, #FF9431 0%, #EA580C 100%)', border: 'none', color: '#fff', fontWeight: 800, cursor: 'pointer', fontSize: '14px', boxShadow: '0 8px 16px rgba(255,148,49,0.15)' }}
                  >
                    Verify & Submit
                  </button>
                </div>
