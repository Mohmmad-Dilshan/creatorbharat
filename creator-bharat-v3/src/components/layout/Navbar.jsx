    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div ref={profileRef} style={{ position: 'relative' }}>
          ...
          >
            <img src={st.user?.creatorProfile?.photo || st.user?.brandProfile?.logo || st.user?.photo || `https://ui-avatars.com/api/?name=${encodeURIComponent(st.user.name || 'User')}&background=FF9431&color=fff`} style={{ width: 34, height: 34, borderRadius: '50%', objectFit: 'cover' }} alt={st.user.name || 'User'} />
