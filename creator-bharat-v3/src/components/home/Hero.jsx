...
export default function Hero({ mob, st, dsp, go }) {
  ...
  return (
    <section style={{ background: '#fff', minHeight: mob ? 'auto' : '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: mob ? 120 : 160, paddingBottom: mob ? 80 : 120, position: 'relative', overflow: 'visible', textAlign: 'center' }}>
