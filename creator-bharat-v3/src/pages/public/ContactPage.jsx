              ...
              <AnimatePresence mode="wait">
                {formState === 'success' ? (
                  ...
                  >
                    ...
                    <Btn lg onClick={() => setFormState('idle')} style={{ background: '#f8fafc', color: '#64748b', borderRadius: '100px' }}>
                  ...
                  <div key="form">
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                       <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                          <div>
                             <label style={{ display: 'block', fontSize: '12px', fontWeight: 900, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '10px' }}>Full Name</label>
                             <input required type="text" placeholder="Arjun Mehta" style={{ width: '100%', padding: '18px 24px', borderRadius: '18px', border: '2px solid #f1f5f9', background: '#fcfcfc', fontSize: '16px', fontWeight: 600, outline: 'none' }} />
                          </div>
                          <div>
                             <label style={{ display: 'block', fontSize: '12px', fontWeight: 900, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '10px' }}>Email Address</label>
                             <input required type="email" placeholder="arjun@email.com" style={{ width: '100%', padding: '18px 24px', borderRadius: '18px', border: '2px solid #f1f5f9', background: '#fcfcfc', fontSize: '16px', fontWeight: 600, outline: 'none' }} />
                          </div>
                       </div>

                       <div>
                          <label style={{ display: 'block', fontSize: '12px', fontWeight: 900, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '10px' }}>Subject</label>
                          <select style={{ width: '100%', padding: '18px 24px', borderRadius: '18px', border: '2px solid #f1f5f9', background: '#fcfcfc', fontSize: '16px', fontWeight: 600, appearance: 'none', outline: 'none' }}>
                             {tab === 'creator' ? (
                               <>
                       ...
                       <div>
                          <label style={{ display: 'block', fontSize: '12px', fontWeight: 900, color: '#94a3b8', textTransform: 'uppercase', marginBottom: '10px' }}>Your Message</label>
                          <textarea required placeholder="How can we help you today?" rows={5} style={{ width: '100%', padding: '18px 24px', borderRadius: '18px', border: '2px solid #f1f5f9', background: '#fcfcfc', fontSize: '16px', fontWeight: 600, outline: 'none', resize: 'none' }} />
                       </div>
