          ...
          <div style={{ display: 'grid', gridTemplateColumns: mob ? '1fr' : '380px 1fr', gap: 40, alignItems: 'start' }}>
            ...
            <div style={{ position: mob ? 'static' : 'sticky', top: 120 }}>
              <Card className="au" style={{ padding: '48px 32px', textAlign: 'center', background: '#fff', boxShadow: '0 20px 40px rgba(0,0,0,0.03)' }}>
                ...
                <h3 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 24, color: '#111', marginTop: 24, fontWeight: 900 }}>{c ? c.name : 'Sample Creator'}</h3>
            ...
            <div className="ai" style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
              <Card style={{ padding: '40px' }}>
                <h3 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 24, fontWeight: 900, color: '#111', marginBottom: 20 }}>How We Calculate Trust</h3>
              ...
              <Card style={{ padding: '40px' }}>
                <h3 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 24, fontWeight: 900, color: '#111', marginBottom: 32 }}>Official Tiering System</h3>
                <div style={{ display: 'grid', gridTemplateColumns: mob ? '1fr' : '1fr 1fr', gap: 20 }}>
                  {[
                    ...
                    <div key={item.t} style={{ padding: '24px', borderRadius: 24, border: `2px solid ${item.c}10`, background: `${item.c}03` }}>
                      <p style={{ fontWeight: 900, color: item.c, fontSize: 18, fontFamily: "'Outfit', sans-serif" }}>{item.t}</p>
